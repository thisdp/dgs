...
function dgsEffect3DApplyToScrollPane(effect3d, scrollpane)
	if not(dgsGetPluginType(effect3d) == "dgs-dxeffect3d") then
		error(dgsGenAsrt(effect3d, "dgsEffect3DApplyToScrollPane", 1, "plugin dgs-dxeffect3d"))
	end

	if not(dgsGetType(scrollpane) == "dgs-dxscrollpane") then
		error(dgsGenAsrt(scrollpane, "dgsEffect3DApplyToScrollPane", 2, "dgs-dxscrollpane"))
	end
...
function dgsEffect3DSetRotationFactor(effect3d, rotFactor)
	if not(dgsGetPluginType(effect3d) == "dgs-dxeffect3d") then
		error(dgsGenAsrt(rectShader, "dgsEffect3DSetRotationFactor", 1, "plugin dgs-dxeffect3d"))
	end
...
function dgsEffect3DGetRotationFactor(effect3d)
	if not(dgsGetPluginType(effect3d) == "dgs-dxeffect3d") then
		error(dgsGenAsrt(rectShader, "dgsEffect3DGetRotationFactor", 1, "plugin dgs-dxeffect3d"))
	end
...
function dgsEffect3DSetAlwaysEnabled(effect3d, state)
	if not(dgsGetPluginType(effect3d) == "dgs-dxeffect3d") then
		error(dgsGenAsrt(rectShader, "dgsEffect3DSetAlwaysEnabled", 1, "plugin dgs-dxeffect3d"))
	end
...
function dgsEffect3DGetAlwaysEnabled(effect3d)
	if not(dgsGetPluginType(effect3d) == "dgs-dxeffect3d") then
		error(dgsGenAsrt(rectShader, "dgsEffect3DGetAlwaysEnabled", 1, "plugin dgs-dxeffect3d"))
	end
