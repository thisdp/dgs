...
function dgsGradientSetTexture(gradShader, texture)
	if not(dgsGetPluginType(gradShader) == "dgs-dxgradient") then
		error(dgsGenAsrt(gradShader, "dgsGradientSetTexture", 1, "plugin dgs-dxgradient"))
	end
...
function dgsGradientGetTexture(gradShader)
	if not(dgsGetPluginType(gradShader) == "dgs-dxgradient") then
		error(dgsGenAsrt(gradShader, "dgsGradientGetTexture", 1, "plugin dgs-dxgradient"))
	end
...
function dgsGradientGetColorOverwritten(gradShader)
	if not(dgsGetPluginType(gradShader) == "dgs-dxgradient") then
		error(dgsGenAsrt(gradShader, "dgsGradientGetColorOverwritten", 1, "plugin dgs-dxgradient"))
	end
...
function dgsGradientSetColorOverwritten(gradShader, colorOverwritten)
	if not(dgsGetPluginType(gradShader) == "dgs-dxgradient") then
		error(dgsGenAsrt(gradShader, "dgsGradientSetColorOverwritten", 1, "plugin dgs-dxgradient"))
	end
