...
-------OOP
if not getElementData(root, "__DGSRes") then
	assert(false, "Invalid DGS Resource! Please check whether your dgs resource is started")
end

if not dgsImportHead then
	loadstring(exports[getElementData(root, "__DGSRes")]:dgsImportFunction())()
end

if dgsOOP and dgsOOP.dgsRes and isElement(getResourceRootElement(dgsOOP.dgsRes)) then
	return
end
...
do
	...
	__index = function(self, key)
		...
		if not isElement(meta.dgsElement) then
			return false
		end
	...
	default = {
		...
		return Vector2(guiGetScreenSize())
	end,
		...
		getCursorPosition = function(self, rltE, rlt, fScreen)
		return dgsGetCursorPosition(rltE and rltE.dgsElement or false, rlt, fScreen)
	end,
		...
		dgs3DImage = function(...)
		return dgsOOP.dgs3DImage(dgsRootInstance, ...)
	end,
		dgs3DInterface = function(...)
		return dgsOOP.dgs3DInterface(dgsRootInstance, ...)
	end,
		dgs3DLine = function(...)
		return dgsOOP.dgs3DLine(dgsRootInstance, ...)
	end,
		dgs3DText = function(...)
		return dgsOOP.dgs3DText(dgsRootInstance, ...)
	end,
		dgsBrowser = function(...)
		return dgsOOP.dgsBrowser(dgsRootInstance, ...)
	end,
		dgsButton = function(...)
		return dgsOOP.dgsButton(dgsRootInstance, ...)
	end,
		dgsCheckBox = function(...)
		return dgsOOP.dgsCheckBox(dgsRootInstance, ...)
	end,
		dgsComboBox = function(...)
		return dgsOOP.dgsComboBox(dgsRootInstance, ...)
	end,
		dgsCustomRenderer = function(...)
		return dgsOOP.dgsCustomRenderer(dgsRootInstance, ...)
	end,
		dgsDetectArea = function(...)
		return dgsOOP.dgsDetectArea(dgsRootInstance, ...)
	end,
		dgsEdit = function(...)
		return dgsOOP.dgsEdit(dgsRootInstance, ...)
	end,
		dgsGridList = function(...)
		return dgsOOP.dgsGridList(dgsRootInstance, ...)
	end,
		dgsImage = function(...)
		return dgsOOP.dgsImage(dgsRootInstance, ...)
	end,
		dgsLabel = function(...)
		return dgsOOP.dgsLabel(dgsRootInstance, ...)
	end,
		dgsLine = function(...)
		return dgsOOP.dgsLine(dgsRootInstance, ...)
	end,
		dgsMemo = function(...)
		return dgsOOP.dgsMemo(dgsRootInstance, ...)
	end,
		dgsProgressBar = function(...)
		return dgsOOP.dgsProgressBar(dgsRootInstance, ...)
	end,
		dgsRadioButton = function(...)
		return dgsOOP.dgsRadioButton(dgsRootInstance, ...)
	end,
		dgsSelector = function(...)
		return dgsOOP.dgsSelector(dgsRootInstance, ...)
	end,
		dgsScrollBar = function(...)
		return dgsOOP.dgsScrollBar(dgsRootInstance, ...)
	end,
		dgsScrollPane = function(...)
		return dgsOOP.dgsScrollPane(dgsRootInstance, ...)
	end,
		dgsScalePane = function(...)
		return dgsOOP.dgsScalePane(dgsRootInstance, ...)
	end,
		dgsSwitchButton = function(...)
		return dgsOOP.dgsSwitchButton(dgsRootInstance, ...)
	end,
		dgsTabPanel = function(...)
		return dgsOOP.dgsTabPanel(dgsRootInstance, ...)
	end,
		dgsWindow = function(...)
		return dgsOOP.dgsWindow(dgsRootInstance, ...)
	end,
	...
	public = {
		...
		dgsBrowser = function(...)
		return dgsOOP.dgsBrowser(...)
	end,
		dgsButton = function(...)
		return dgsOOP.dgsButton(...)
	end,
		dgsCheckBox = function(...)
		return dgsOOP.dgsCheckBox(...)
	end,
		dgsComboBox = function(...)
		return dgsOOP.dgsComboBox(...)
	end,
		dgsDetectArea = function(...)
		return dgsOOP.dgsDetectArea(...)
	end,
		dgsEdit = function(...)
		return dgsOOP.dgsEdit(...)
	end,
		dgsGridList = function(...)
		return dgsOOP.dgsGridList(...)
	end,
		dgsImage = function(...)
		return dgsOOP.dgsImage(...)
	end,
		dgsLabel = function(...)
		return dgsOOP.dgsLabel(...)
	end,
		dgsLine = function(...)
		return dgsOOP.dgsLine(...)
	end,
		dgsMemo = function(...)
		return dgsOOP.dgsMemo(...)
	end,
		dgsProgressBar = function(...)
		return dgsOOP.dgsProgressBar(...)
	end,
		dgsRadioButton = function(...)
		return dgsOOP.dgsRadioButton(...)
	end,
		dgsSelector = function(...)
		return dgsOOP.dgsSelector(...)
	end,
		dgsScrollBar = function(...)
		return dgsOOP.dgsScrollBar(...)
	end,
		dgsScrollPane = function(...)
		return dgsOOP.dgsScrollPane(...)
	end,
		dgsScalePane = function(...)
		return dgsOOP.dgsScalePane(...)
	end,
		dgsSwitchButton = function(...)
		return dgsOOP.dgsSwitchButton(...)
	end,
		dgsTabPanel = function(...)
		return dgsOOP.dgsTabPanel(...)
	end,
		dgsWindow = function(...)
		return dgsOOP.dgsWindow(...)
	end,
		...
		----------Plugins
		dgsColorPicker = function(...)
		return dgsOOP.dgsColorPicker(...)
	end,
		dgsComponentSelector = function(...)
		return dgsOOP.dgsComponentSelector(...)
	end,
		dgsSVG = function(...)
		return dgsOOP.dgsSVG(...)
	end,
	...
	public = {
		...
		return dgsGetProperties(self.dgsElement, ...)
	end,
	...
	public = {
		...
		attachToGridList = function(self, targetGridList, ...)
		return dgsAttachToGridList(self.dgsElement, targetGridList.dgsElement, ...) and self or false
	end,
	...
	getElement = function(self)
		...
		addDragHandler = gObjFnc("dgsAddDragHandler", true),
		removeDragHandler = gObjFnc("dgsRemoveDragHandler", true),
		applyDetectArea = function(self, da)
		return dgsApplyDetectArea(self.dgsElement, da.dgsElement)
	end,
	...
	preInstantiate = function(parent, x, y, w, h, image, rlt, ...)
		if type(image) == "table" then
			image = image.dgsElement or image
		end
	...
	default = {
		...
		return self
			...
			svg = {
				rect = function(self, ...)
		return dgsGetInstanceByType(dgsSVGCreateNode(self.dgsElement, "rect", ...), "dgs-dxsvgnode")
	end,
				circle = function(self, ...)
		return dgsGetInstanceByType(dgsSVGCreateNode(self.dgsElement, "circle", ...), "dgs-dxsvgnode")
	end,
				ellipse = function(self, ...)
		return dgsGetInstanceByType(dgsSVGCreateNode(self.dgsElement, "ellipse", ...), "dgs-dxsvgnode")
	end,
				line = function(self, ...)
		return dgsGetInstanceByType(dgsSVGCreateNode(self.dgsElement, "line", ...), "dgs-dxsvgnode")
	end,
				polygon = function(self, ...)
		return dgsGetInstanceByType(dgsSVGCreateNode(self.dgsElement, "polygon", ...), "dgs-dxsvgnode")
	end,
				polyline = function(self, ...)
		return dgsGetInstanceByType(dgsSVGCreateNode(self.dgsElement, "polyline", ...), "dgs-dxsvgnode")
	end,
				path = function(self, ...)
		return dgsGetInstanceByType(dgsSVGCreateNode(self.dgsElement, "path", ...), "dgs-dxsvgnode")
	end,
				text = function(self, ...)
		return dgsGetInstanceByType(dgsSVGCreateNode(self.dgsElement, "text", ...), "dgs-dxsvgnode")
	end,
			},
			rect = {
				move = function(self, ...)
		...
		return self
				...
				tspan = function(self, ...)
		return dgsGetInstanceByType(dgsSVGCreateNode(self.dgsElement, "tspan", ...), "dgs-dxsvgnode")
	end,
			}
		}
	};
