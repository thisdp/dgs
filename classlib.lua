...
class {
	...
	public = {
		...
		getColumnAlignment = dgsOOP.genOOPFnc("dgsGridListGetColumnAlignment"),
		setColumnAlignment = dgsOOP.genOOPFnc("dgsGridListSetColumnAlignment",true),
		...
		getItemAlignment = dgsOOP.genOOPFnc("dgsGridListGetItemAlignment"),
		setItemAlignment = dgsOOP.genOOPFnc("dgsGridListSetItemAlignment",true),
