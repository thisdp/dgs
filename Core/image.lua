...
function dgsCreateImage(...)
	...
	if not(type(x) == "number") then
		error(dgsGenAsrt(x, "dgsCreateImage", 1, "number"))
	end

	if not(type(y) == "number") then
		error(dgsGenAsrt(y, "dgsCreateImage", 2, "number"))
	end

	if not(type(w) == "number") then
		error(dgsGenAsrt(w, "dgsCreateImage", 3, "number"))
	end

	if not(type(h) == "number") then
		error(dgsGenAsrt(h, "dgsCreateImage", 4, "number"))
	end
...
function dgsImageGetImage(image)
	if dgsGetType(image) ~= "dgs-dximage" then
		error(dgsGenAsrt(image, "dgsImageGetImage", 1, "dgs-dximage"))
	end
...
function dgsImageSetImage(image, img)
	if dgsGetType(image) ~= "dgs-dximage" then
		error(dgsGenAsrt(image, "dgsImageSetImage", 1, "dgs-dximage"))
	end
...
function dgsImageSetUVSize(image, sx, sy, relative)
	if dgsGetType(image) ~= "dgs-dximage" then
		error(dgsGenAsrt(image, "dgsImageSetUVSize", 1, "dgs-dximage"))
	end
...
function dgsImageGetUVSize(image, relative)
	if dgsGetType(image) ~= "dgs-dximage" then
		error(dgsGenAsrt(image, "dgsImageGetUVSize", 1, "dgs-dximage"))
	end
...
function dgsImageSetUVPosition(image, x, y, relative)
	if dgsGetType(image) ~= "dgs-dximage" then
		error(dgsGenAsrt(image, "dgsImageSetUVPosition", 1, "dgs-dximage"))
	end
...
function dgsImageGetUVPosition(image, relative)
	if dgsGetType(image) ~= "dgs-dximage" then
		error(dgsGenAsrt(image, "dgsImageGetUVPosition", 1, "dgs-dximage"))
	end
...
function dgsImageGetNativeSize(image)
	if dgsGetType(image) ~= "dgs-dximage" then
		error(dgsGenAsrt(image, "dgsImageGetNativeSize", 1, "dgs-dximage"))
	end
