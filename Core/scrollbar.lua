...
function dgsCreateScrollBar(...)
	...
	if not(type(x) == "number") then
		error(dgsGenAsrt(x, "dgsCreateScrollBar", 1, "number"))
	end

	if not(type(y) == "number") then
		error(dgsGenAsrt(y, "dgsCreateScrollBar", 2, "number"))
	end

	if not(type(w) == "number") then
		error(dgsGenAsrt(w, "dgsCreateScrollBar", 3, "number"))
	end

	if not(type(h) == "number") then
		error(dgsGenAsrt(h, "dgsCreateScrollBar", 4, "number"))
	end
...
function dgsScrollBarSetScrollPosition(scrollbar, pos, isGrade, isAbsolute)
	if dgsGetType(scrollbar) ~= "dgs-dxscrollbar" then
		error(dgsGenAsrt(scrollbar, "dgsScrollBarSetScrollPosition", 1, "dgs-dxscrollbar"))
	end

	if not(type(pos) == "number") then
		error(dgsGenAsrt(pos, "dgsScrollBarSetScrollPosition", 2, "number"))
	end
...
function dgsScrollBarGetScrollPosition(scrollbar, isGrade, isAbsolute)
	if dgsGetType(scrollbar) ~= "dgs-dxscrollbar" then
		error(dgsGenAsrt(scrollbar, "dgsScrollBarGetScrollPosition", 1, "dgs-dxscrollbar"))
	end
...
function dgsScrollBarSetLocked(scrollbar, state)
	if dgsGetType(scrollbar) ~= "dgs-dxscrollbar" then
		error(dgsGenAsrt(scrollbar, "dgsScrollBarSetLocked", 1, "dgs-dxscrollbar"))
	end
...
function dgsScrollBarGetLocked(scrollbar)
	if dgsGetType(scrollbar) ~= "dgs-dxscrollbar" then
		error(dgsGenAsrt(scrollbar, "dgsScrollBarGetLocked", 1, "dgs-dxscrollbar"))
	end
...
function dgsScrollBarSetGrades(scrollbar, grades, remainMultipler)
	if dgsGetType(scrollbar) ~= "dgs-dxscrollbar" then
		error(dgsGenAsrt(scrollbar, "dgsScrollBarSetGrades", 1, "dgs-dxscrollbar"))
	end

	if grades and (type(grades) ~= "number" or grades <= 0) then
		error(dgsGenAsrt(grades, "dgsScrollBarSetGrades", 2, "number"))
	end
...
function dgsScrollBarGetGrades(scrollbar)
	if dgsGetType(scrollbar) ~= "dgs-dxscrollbar" then
		error(dgsGenAsrt(scrollbar, "dgsScrollBarGetGrades", 1, "dgs-dxscrollbar"))
	end
...
function dgsScrollBarSetCursorLength(scrollbar, length, relative)
	if dgsGetType(scrollbar) ~= "dgs-dxscrollbar" then
		error(dgsGenAsrt(scrollbar, "dgsScrollBarSetCursorLength", 1, "dgs-dxscrollbar"))
	end

	if not(type(length) == "number") then
		error(dgsGenAsrt(length, "dgsScrollBarSetCursorLength", 2, "number"))
	end
...
function dgsScrollBarGetCursorLength(scrollbar, relative)
	if dgsGetType(scrollbar) ~= "dgs-dxscrollbar" then
		error(dgsGenAsrt(scrollbar, "dgsScrollBarGetCursorLength", 1, "dgs-dxscrollbar"))
	end
...
function dgsScrollBarSetCursorWidth(scrollbar, width, relative)
	if dgsGetType(scrollbar) ~= "dgs-dxscrollbar" then
		error(dgsGenAsrt(scrollbar, "dgsScrollBarSetCursorWidth", 1, "dgs-dxscrollbar"))
	end

	if not(type(width) == "number") then
		error(dgsGenAsrt(width, "dgsScrollBarSetCursorWidth", 2, "number"))
	end
...
function dgsScrollBarGetCursorWidth(scrollbar, relative)
	if dgsGetType(scrollbar) ~= "dgs-dxscrollbar" then
		error(dgsGenAsrt(scrollbar, "dgsScrollBarGetCursorWidth", 1, "dgs-dxscrollbar"))
	end

	if not(type(width) == "number") then
		error(dgsGenAsrt(width, "dgsScrollBarGetCursorWidth", 2, "number"))
	end
...
function dgsScrollBarSetTroughWidth(scrollbar, width, relative)
	if dgsGetType(scrollbar) ~= "dgs-dxscrollbar" then
		error(dgsGenAsrt(scrollbar, "dgsScrollBarSetTroughWidth", 1, "dgs-dxscrollbar"))
	end

	if not(type(width) == "number") then
		error(dgsGenAsrt(width, "dgsScrollBarSetTroughWidth", 2, "number"))
	end
...
function dgsScrollBarGetTroughWidth(scrollbar, relative)
	if dgsGetType(scrollbar) ~= "dgs-dxscrollbar" then
		error(dgsGenAsrt(scrollbar, "dgsScrollBarGetTroughWidth", 1, "dgs-dxscrollbar"))
	end
...
function dgsScrollBarSetArrowSize(scrollbar, size, relative)
	if dgsGetType(scrollbar) ~= "dgs-dxscrollbar" then
		error(dgsGenAsrt(scrollbar, "dgsScrollBarSetArrowSize", 1, "dgs-dxscrollbar"))
	end

	if not(type(size) == "number") then
		error(dgsGenAsrt(size, "dgsScrollBarSetArrowSize", 2, "number"))
	end
...
function dgsScrollBarGetArrowSize(scrollbar, relative)
	if dgsGetType(scrollbar) ~= "dgs-dxscrollbar" then
		error(dgsGenAsrt(scrollbar, "dgsScrollBarGetArrowSize", 1, "dgs-dxscrollbar"))
	end
...
function dgsScrollBarSetTroughClickAction(scrollbar, action)
	if dgsGetType(scrollbar) ~= "dgs-dxscrollbar" then
		error(dgsGenAsrt(scrollbar, "dgsScrollBarSetTroughClickAction", 1, "dgs-dxscrollbar"))
	end

	if not(allowedClickAction[action]) then
		error(dgsGenAsrt(action, "dgsScrollBarSetTroughClickAction", 2, "string", "'none'/'step'/'jump'"))
	end
...
function dgsScrollBarGetTroughClickAction(scb)
	if dgsGetType(scrollbar) ~= "dgs-dxscrollbar" then
		error(dgsGenAsrt(scrollbar, "dgsScrollBarGetTroughClickAction", 1, "dgs-dxscrollbar"))
	end
